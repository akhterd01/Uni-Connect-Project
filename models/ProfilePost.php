...
class ProfilePost {
    ...
    public function uploadPostData($userID, $wallPostData, $image, $username) {
        $this->db->prepare("INSERT INTO profileposts (post_user_id, post_content, post_image, postusername) VALUES 
        (:post_user_id, :post_content, :post_image, :postusername)");
        $this->db->bindValue(":post_user_id", $userID);
        $this->db->bindValue(":post_content", $wallPostData);
        $this->db->bindValue(":post_image", $image);
    ...
    public function updatePosts() {
        ...
        $textContent = "<div class='create-a-post' id='new-post-container'>
        <form class='post-form new-post-form' id='new-post-form'>
        ...
        foreach($rows as $row) {
            ...
            $textContent .= "<div class='profile-post'>
            ...
            $textContent .= "<div class='comment-reply-container'>
