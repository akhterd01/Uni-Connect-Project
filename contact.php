...
<div class="profile-page-container profile-page-container-fix">
    <div class="profile-settings-container">
        ...
        <a href="contact.php"><h3 style="background-color: rgb(241, 236, 236); border-left: 2px solid rgb(54, 122, 248);"class="p-s-contact">Contact</h3></a> 
        </div>
